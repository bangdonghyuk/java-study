...
public class VariableTest {
	...
	double realNumber  = 0.0012381273971280001; // 실수(double)값을 저장하는 value 변수의 선언.
...
//	4. 자바 예약어 사용금지 (ex: void, new, private, boolean 등)
	...
	System.out.println("int age value is ["+ ageEx +"]");
	
	System.out.println("int age value is ["+ realNumber +"]");
